function renderKindHeading(kind) {
    switch (kind) {
        case 'history_view':
            return '# History View';
        case 'snapshot_view':
...
export function renderStubToMarkdown(vm) {
    ...
    const warningLines = vm.warnings.length > 0
...
//# sourceMappingURL=presentation-skill-stub.js.map