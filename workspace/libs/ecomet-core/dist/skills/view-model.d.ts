export type ViewModelKind = 'history_view' | 'snapshot_view' | 'aggregate_table' | 'alarm_list' | 'alarm_summary' | 'scope_view' | 'coverage_view';
...
export interface AlarmSummaryMetrics {
    ...
    standing_alarms: Array<{
        source: string;
        message?: string;
        since: number;
    }>;
    chattering_alarms: Array<{
        source: string;
        count: number;
...
export type ViewModelBlock = HistoryBlock | SnapshotBlock | AggregateTableBlock | AlarmListBlock | AlarmSummaryBlock | ScopeBlock | CoverageBlock;
