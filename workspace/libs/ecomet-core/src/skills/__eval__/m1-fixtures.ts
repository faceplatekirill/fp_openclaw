...
export const M1_EVAL_FIXTURES: M1EvalFixture[] = [
  {
    id: 'RF-1',
    type: 'routing',
    ...
    expected_behavior:
      'Route to discovery first so the skill narrows the canonical object path before any deeper read.',
    anti_pattern:
      'Treat a vague asset reference as if the full archive tag were already known and jump directly to history.',
  },
  {
    id: 'RF-2',
    type: 'routing',
    ...
    expected_behavior:
      'Use discovery to summarize the available object types or patterns in scope.',
    anti_pattern:
      'Treat a topology question as a telemetry-quality question.',
  },
  {
    id: 'RF-3',
    type: 'routing',
    ...
    expected_behavior:
      'Use the history skill for known-tag trend data with resolved time semantics and partiality handling.',
    anti_pattern:
      'Route a trend request to the exact-time snapshot path.',
  },
  {
    id: 'RF-4',
    type: 'routing',
    ...
    expected_behavior:
      'Use the snapshot skill for one exact-time value with invalid and unresolved outcomes preserved.',
    anti_pattern:
      'Substitute a trend table for an exact-time read.',
  },
  {
    id: 'RF-5',
    type: 'routing',
    ...
    expected_behavior:
      'Use the aggregate skill so bucket edges and function semantics are deterministic in code.',
    anti_pattern:
      'Treat an aggregate request as a raw history read and leave bucketing to the model.',
  },
  {
    id: 'RF-6',
    type: 'routing',
    ...
    expected_behavior:
      'Run the canonical aggregate-first json chain before any exact-timestamp follow-up.',
    anti_pattern:
      'Do history-first reasoning with no typed aggregate step.',
  },
  {
    id: 'RF-7',
    type: 'routing',
    ...
    expected_behavior:
      'Use the coverage skill to report archived and unarchived outcomes explicitly.',
    anti_pattern:
      'Probe history first instead of answering the archive-existence question directly.',
  },
  {
    id: 'RF-8',
    type: 'routing',
    ...
    expected_behavior:
      'Use the deterministic alarm list skill for rows, totals, and continuation guidance.',
    anti_pattern:
      'Switch to an alarm-summary or raw-tool-first path instead of the direct alarm-list surface.',
  },
  {
    id: 'RF-9',
    type: 'routing',
    ...
    expected_behavior:
      'Use the conservative data-quality skill so archive, current fields, and recent history are combined without over-diagnosis.',
    anti_pattern:
      'Answer a freshness question with a plain history read and no current quality facts.',
  },
  {
    id: 'OF-1',
    ...
    expected_behavior:
      'Return one scope block with mapped paths, type summary, provenance, and completeness signaling.',
    anti_pattern:
      'Return ad hoc markdown or drop pagination metadata from the structured output.',
  },
  {
    id: 'OF-2',
    type: 'output_contract',
    ...
    expected_behavior:
      'Keep the valid history block, preserve warnings, and keep provenance tied to the resolved request window.',
    anti_pattern:
      'Drop the valid block or hide invalid-tag warnings in the structured output.',
  },
  {
    id: 'OF-3',
    type: 'output_contract',
    ...
    expected_behavior:
      'Return one snapshot block where valid null values remain in values and invalid or unresolved tags remain explicit.',
    anti_pattern:
      'Collapse all missing-looking outcomes into null.',
  },
  {
    id: 'OF-4',
    type: 'output_contract',
    ...
    expected_behavior:
      'Return aggregate_table blocks with deterministic rows, bucket description, and caveats.',
    anti_pattern:
      'Omit bucket metadata or hide time-weighting caveats in prose only.',
  },
  {
    id: 'OF-5',
    type: 'output_contract',
    ...
    expected_behavior:
      'Return one coverage block with archived, unarchived, and summary counts preserved.',
    anti_pattern:
      'Drop unarchived rows from the response.',
  },
  {
    id: 'OF-6',
    type: 'output_contract',
    ...
    expected_behavior:
      'Return alarm_list with the merged total, partial completeness, and continuation guidance.',
    anti_pattern:
      'Present a first page as if it were a complete alarm list.',
  },
  {
    id: 'OF-7',
    type: 'output_contract',
    ...
    expected_behavior:
      'Return one coverage block with archive, current quality, timestamp, and recent-history facts.',
    anti_pattern:
      'Invent a root cause instead of reporting conservative facts.',
  },
  {
    id: 'EF-1',
    type: 'edge_case',
    ...
    expected_behavior:
      'Return projected fields for the page, avoid extra read phases, and preserve pagination-based completeness only.',
    anti_pattern:
      'Reintroduce a second read phase or synthetic partiality just because the projected page is broad.',
  },
  {
    id: 'EF-2',
    type: 'edge_case',
    ...
    expected_behavior:
      'Keep the block valid and add a note that the earlier point may define the effective range-start value.',
    anti_pattern:
      'Silently trim the earlier point and imply the start value was unknown.',
  },
  {
    id: 'EF-3',
    type: 'edge_case',
    ...
    expected_behavior:
      'Keep an empty history block and add a no-data note.',
    anti_pattern:
      'Drop the tag entirely because the series is empty.',
  },
  {
    id: 'EF-4',
    type: 'edge_case',
    ...
    expected_behavior:
      'Keep only valid-null tags in values and preserve invalid and unresolved lists explicitly.',
    anti_pattern:
      'Collapse distinct failure modes into null.',
  },
  {
    id: 'EF-5',
    type: 'edge_case',
    ...
    expected_behavior:
      'Keep local day boundaries, explicit timezone provenance, and DST caveats when day length changes.',
    anti_pattern:
      'Step in UTC with no disclosure and lose local-day semantics.',
  },
  {
    id: 'EF-6',
    type: 'edge_case',
    ...
    expected_behavior:
      'Batch internally and still return entries in first-seen input order after de-duplication.',
    anti_pattern:
      'Silently truncate or reorder rows by batch.',
  },
  {
    id: 'EF-7',
    type: 'edge_case',
    ...
    expected_behavior:
      'Split the range into compliant windows, merge deterministically, and disclose the split.',
    anti_pattern:
      'Send one illegal 45-day alarm query or silently truncate to 30 days.',
  },
  {
    id: 'EF-8',
    type: 'edge_case',
    ...
    expected_behavior:
      'Mark the result partial, preserve accurate totals, and include continuation guidance.',
    anti_pattern:
      'Present the returned subset as a complete list.',
  },
  {
    id: 'EF-9',
    type: 'edge_case',
    ...
    expected_behavior:
      'Report raw facts about archive, companion fields, and recent history without diagnosing failure.',
    anti_pattern:
      'Declare sensor failure from flat history alone.',
  },
];
